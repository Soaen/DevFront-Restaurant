  ...
  return (
    <div>
      ...
      <article className="artcResto">
        <img className="img2" src="./Imagesresto/resto4.png" alt="Image resto" />
      ...
      <article className="artcChef">
        <img className="img3" src="./Imagesresto/resto5.png" alt="" />
        <h3 className="h3Home2">Le chef cuisto</h3>
